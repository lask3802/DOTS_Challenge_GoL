...
* [DOTS Challenge Conway's Game of Life](#dots-challenge-conways-game-of-life)
  ...
  * [Devlog](#devlog)
    ...
    * [Play Around with Burst](#play-around-with-burst)
...
### Play Around with Burst
I experimented with various methods to optimize the assembly language generated by Burst, including attempting to vectorize loops as much as possible, reducing the number of branches, and altering the order of code among other tactics. Eliminating branches had the most significant impact on performance, as it enabled Burst to generate more SIMD instructions. Moreover, unless it's necessary to use functions from the math library, avoid using structures like int2 for storing 2D coordinates and performing basic operations, as it tends to decrease performance in most cases.
